...
-- =====================================================================
-- 作成日: 2025-10-02
-- 目的: 確認済みv5スキーマに基づくv6互換テーブル・ビュー作成
...
SELECT
  ...
  s.creator_id,
  s.work_id,
  p.user_id AS buyer_id,  -- purchasesテーブルから取得

  -- Revenue (v5 salesテーブルのカラム)
...
COMMENT ON VIEW sales_vw IS 'v6 compatible: Sales view based on v5 sales table';


-- =============================================================================
-- 7. publishing_approvals_vw: v5テーブルベース
-- =============================================================================
...
-- =============================================================================
-- 8. factory_orders_vw: v6 fulfillmentsベース（推奨方針B）
-- =============================================================================
...
SELECT
  ...
  uv.display_name AS customer_name,
...
COMMENT ON VIEW factory_orders_vw IS 'v6: Factory orders view with customer-facing product info (fulfillments-based)';


-- =============================================================================
-- 9. purchases_vw: v5 purchasesテーブル
-- =============================================================================
...
SELECT
  ...
  p.user_id,
  p.work_id,
  NULL::uuid AS product_id,  -- v5 purchasesにはproduct_idなし
  1 AS quantity,
...
-- =============================================================================
-- 12. refund_requests_vw: v5 refund_requestsテーブル
-- =============================================================================
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '═══════════════════════════════════════════════════════════════';
  RAISE NOTICE '✅ v5 → v6 完全互換SQL適用完了';
  RAISE NOTICE '═══════════════════════════════════════════════════════════════';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '  ✅ factory_orders_vw (v5 manufacturing_orders ベース)';
  RAISE NOTICE '  ✅ purchases_vw (v5 purchases ベース)';
  RAISE NOTICE '  ✅ works_vw (v5 works ベース)';
  RAISE NOTICE '  ✅ users_vw (v5 users ベース)';
