-- Unified finalize transaction for live offers: reserve->confirm + purchase insert + tagging
-- This function should be called from webhook after Stripe confirms payment
