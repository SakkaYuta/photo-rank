  ...
  public: {
      ...
      fulfillment_events: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["fulfillment_id"]
            isOneToOne: false
            referencedRelation: "manufacturing_orders_vw"
            referencedColumns: ["id"]
          },
        ]
      }
      fulfillments: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["partner_id"]
            isOneToOne: false
            referencedRelation: "factory_profiles_vw"
      ...
      order_addresses: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "purchases_vw"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      partner_product_mockups: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "factory_products_vw"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "partner_product_mockups_partner_product_id_fkey"
    ...
    Views: {
      ...
      manufacturing_orders_vw: {
        Row: {
          ...
          shipment_status: Database["public"]["Enums"]["shipment_state"] | null
          status: Database["public"]["Enums"]["fulfillment_state"] | null
          tracking_number: string | null
          updated_at: string | null
        }
        Relationships: [
      ...
      purchases_vw: {
        Row: {
          ...
          creator_id: string | null
          id: string | null
          payment_status: Database["public"]["Enums"]["payment_state"] | null
          price: number | null
    ...
    Functions: {
      ...
      complete_purchase_transaction: {
        Args: { p_amount_jpy?: number; p_payment_intent_id: string }
        Returns: Json
      }
