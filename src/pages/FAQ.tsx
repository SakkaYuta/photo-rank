...
const faqCategories: FAQCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'partner-organizer-approval',
        question: '工場・印刷業者・オーガナイザーの登録について',
        answer: 'これらの登録は承認制です。申請受付後、2週間以内を目安に、登録可否をメールでご連絡します（審査状況により前後する場合があります）。\n・申請時に必要書類の提出をお願いする場合があります\n・審査の結果に関する個別の理由開示は行っておりません'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Stripe決済では、決済完了時にStripeからレシート（電子領収書）メールが自動送信されます。\n・当サイトのマイページからの発行/ダウンロードはできません\n・商品への領収書/納品書の同梱は行っていません'
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'いいえ、同梱していません。Stripeから送信されるレシートメールをご利用ください。'
      }
    ]
  }
]
